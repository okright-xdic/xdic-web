...
// ✅ 사용자가 한번이라도 “마이크 ON”을 만들었으면 이후 Always ON 유지
...
export default function SearchInput({
  ...
  // =========================================================
  // (B) Native(앱) 루프: capgo 플러그인은 “리스너로 결과 수신”
  // =========================================================
  ...
  useEffect(() => {
    ...
    // ✅ 한번 켜면 “사용자 의도”로 저장 (Always ON 정책 시작점)
    try {
